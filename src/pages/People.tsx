    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button onClick={handleNewPerson} className="shadow-lg hover:shadow-xl transition-shadow">
      ...
      {enabledSearch && searchTerm ? (
        <>
          {viewMode === "table" ? (
            <PeopleTableView people={people} onView={handleViewPerson} onEdit={handleEditPerson} />
          ) : (
            <PeopleCardView people={people} onView={handleViewPerson} onEdit={handleEditPerson} />
          )}
          
          {isFetchingNextPage && (
            <div className="text-center py-4">Carregando mais pessoas...</div>
          )}
        </>
      ) : (
